...
from .views import ApplyLeaveAPIView, AttendenceLogAPIView, AttendenceLogListAPIView, CheckInAPIView, EmployeeCreateAPIView, EmployeeDetailsAPIView, EmployeeLeaveApproveAPI, EmployeeLeaveCancelAPI, EmployeeLeavesAPIView, EmployeeModelList, EmployeePositionAPIView, FileUploadView, HolidaysListAPIView, HolidaysListCreateAPIView, LeavesHistoryViewSet, UserRegistrationView, UserLoginView, UserListView, YourApiView, download_file
...
urlpatterns = [
    ...
    path('attendence-log/create', AttendenceLogAPIView.as_view(), name='attendence-log-create'),
    path('holidays-list/create/', HolidaysListCreateAPIView.as_view(), name='holidays-list-create'),
    path('holidays-list/', HolidaysListAPIView.as_view(), name='holidays-list'),
    path('attendence-log/', AttendenceLogListAPIView.as_view(), name='attendence-log'),
